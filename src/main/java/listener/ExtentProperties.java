...
public enum ExtentProperties {
	 ...
	 * 
	 * @param klovProjectName
	 *            The Klov project name
	 */
	 ...
	 * 
	 * @param klovReportName
	 *            The Klov report name
	 */
	 ...
	 * 
	 * @return true if all tests to be added to single klov build and false if
	 *         one build per thread will be created
	 */
	 ...
	 *            The mongoDB database name to store Klov reports
	 */
	...
	/**
	 * Sets the mongoDB username. No need to set username if mongoDB is not
	 * running in --auth mode
	 * 
	 * @param mongodbUsername
	...
	/**
	 * Sets the mongoDB user password No need to set password if mongoDB is not
	 * running in --auth mode
	 * 
	 * @param mongodbPassword
